...
public class JAVA_031_File_Access_01_BufferedWriter
{      
       public static void main(String[] args) 
       {
              ...
              try 
              {
                 ...
                 //FileWriter The_File = new FileWriter("The_Message.txt",true); //Passing in 2nd argument of "true" APPENDS to file
